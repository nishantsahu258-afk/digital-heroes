  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        <img
          src="https://images.unsplash.com/photo-1535131749006-b7f58c99034b?w=1200&q=80&fit=crop"
          alt="Golf course"
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          <div className="flex items-center gap-3">
            ...
            <span className="text-white font-serif text-xl">Digital Heroes</span>
          </div>
          <div>
            <p className="text-white/60 text-sm font-bold uppercase tracking-widest mb-4">The Premium Golf Platform</p>
            <h2 className="text-white text-4xl font-serif leading-tight mb-6">
              Play. Win.<br />Change Lives.
            </h2>
            <p className="text-white/70 text-sm leading-relaxed max-w-xs">
              Log your Stableford scores, enter monthly draws, and fund world-changing charity projects.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col bg-background">
        ...
        <div className="flex-1 flex items-center justify-center p-6">
          <Card className="w-full max-w-[440px] shadow-xl shadow-black/5 border-foreground/5 py-4">
                ...
                <div className="space-y-3">
                  ...
                  <motion.div animate={shakeAnimation} transition={{ duration: 0.3 }} className="relative">
                    ...
                    <button
                      ...
                      className="absolute right-3 top-3 text-foreground/40 hover:text-foreground/70 transition-colors focus:outline-none"
